# jan/02/1970 01:22:42 by RouterOS 6.43.8
# software id = QA4R-B09A
#
# model = RouterBOARD 941-2nD
# serial number = 661705E84C20
/interface ethernet
set [ find default-name=ether1 ] advertise=\
    ...
    E4:8D:8C:D2:E9:05 mtu=1500 name=ether1 orig-mac-address=E4:8D:8C:D2:E9:05 \
...
set [ find default-name=ether2 ] advertise=\
    ...
    disabled=no full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    E4:8D:8C:D2:E9:06 mtu=1500 name=ether2 orig-mac-address=E4:8D:8C:D2:E9:06 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    ...
    disabled=no full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    E4:8D:8C:D2:E9:07 mtu=1500 name=ether3 orig-mac-address=E4:8D:8C:D2:E9:07 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether4 ] advertise=\
    ...
    disabled=no full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    E4:8D:8C:D2:E9:08 mtu=1500 name=ether4 orig-mac-address=E4:8D:8C:D2:E9:08 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
/interface bridge
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=none allow-sharedkey=\
    ...
    mac-address=E4:8D:8C:D2:E9:09 max-station-count=2007 mode=ap-bridge mtu=\
    ...
    radio-name=E48D8CD2E909 rate-selection=advanced rate-set=default \
    rx-chains=0,1 scan-list=default secondary-channel="" security-profile=\
    default ssid=Router-A1 station-bridge-clone-mac=00:00:00:00:00:00 \
...
/ip pool
add name=Mgmt ranges=192.168.50.10-192.168.50.100
add name=ether1 ranges=192.168.111.10-192.168.111.50
add name=ether2 ranges=192.168.112.10-192.168.112.50
/ip dhcp-server
...
add disabled=no list=mactel
add disabled=no interface=wlan1 list=mac-winbox
add disabled=no list=mac-winbox
...
add address=192.168.50.1/24 comment=Mgmt disabled=no interface=wlan1 network=\
    192.168.50.0
add address=192.168.111.1/24 disabled=no interface=ether1 network=\
    192.168.111.0
add address=192.168.112.1/24 disabled=no interface=ether2 network=\
    192.168.112.0
add address=192.168.110.1/24 disabled=no interface=loopback0 network=\
    192.168.110.0
/ip cloud
...
add address=192.168.111.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway=192.168.111.1 netmask=24 ntp-server="" wins-server=""
add address=192.168.112.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway=192.168.112.1 netmask=24 ntp-server="" wins-server=""
/ip dns
