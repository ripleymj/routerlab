...
set [ find default-name=ether1 ] advertise=\
    ...
    B8:69:F4:B5:3F:EE mtu=1500 name=ether1 orig-mac-address=B8:69:F4:B5:3F:EE \
...
set [ find default-name=ether2 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:3F:EF mtu=1500 name=ether2 orig-mac-address=B8:69:F4:B5:3F:EF \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:3F:F0 mtu=1500 name=ether3 orig-mac-address=B8:69:F4:B5:3F:F0 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether4 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:3F:F1 mtu=1500 name=ether4 orig-mac-address=B8:69:F4:B5:3F:F1 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
/queue interface
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=none allow-sharedkey=\
    ...
    mac-address=B8:69:F4:B5:3F:F3 max-station-count=2007 mode=ap-bridge mtu=\
    ...
    radio-name=B869F4B53FF3 rate-selection=advanced rate-set=default \
    rx-chains=0,1 scan-list=default secondary-channel="" security-profile=\
    default ssid=Router-B4 station-bridge-clone-mac=00:00:00:00:00:00 \
...
add name=ether1 ranges=192.168.241.10-192.168.241.50
add name=ether2 ranges=192.168.242.10-192.168.242.50
/ip dhcp-server
...
set auth=sha1,md5 cipher=blowfish128,aes128 default-profile=default enabled=\
    no keepalive-timeout=60 mac-address=FE:F1:A5:BE:0E:29 max-mtu=1500 mode=\
...
add address=192.168.241.1/24 disabled=no interface=ether1 network=\
    192.168.241.0
...
add address=192.168.241.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway="" ntp-server="" wins-server=""
add address=192.168.242.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway="" ntp-server="" wins-server=""
/ip dns
