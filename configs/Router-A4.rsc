# jan/02/1970 02:49:28 by RouterOS 6.43.8
# software id = L1TI-TQTW
#
# model = RouterBOARD 941-2nD
# serial number = 5C15040AB665
/interface bridge
add ageing-time=5m arp=enabled arp-timeout=auto auto-mac=yes dhcp-snooping=no \
    disabled=no fast-forward=no forward-delay=15s igmp-snooping=no \
...
set [ find default-name=ether1 ] advertise=\
    ...
    4C:5E:0C:59:F0:94 mtu=1500 name=ether1 orig-mac-address=4C:5E:0C:59:F0:94 \
...
set [ find default-name=ether2 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    4C:5E:0C:59:F0:95 mtu=1500 name=ether2 orig-mac-address=4C:5E:0C:59:F0:95 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    4C:5E:0C:59:F0:96 mtu=1500 name=ether3 orig-mac-address=4C:5E:0C:59:F0:96 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether4 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    4C:5E:0C:59:F0:97 mtu=1500 name=ether4 orig-mac-address=4C:5E:0C:59:F0:97 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
/queue interface
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=none allow-sharedkey=\
    ...
    mac-address=4C:5E:0C:59:F0:98 max-station-count=2007 mode=ap-bridge mtu=\
    ...
    radio-name=4C5E0C59F098 rate-selection=advanced rate-set=default \
    rx-chains=0,1 scan-list=default secondary-channel="" security-profile=\
    default ssid=Router-A4 station-bridge-clone-mac=00:00:00:00:00:00 \
...
add name=ether1 ranges=192.168.141.10-192.168.141.50
add name=ether2 ranges=192.168.142.10-192.168.142.50
/ip dhcp-server
...
add address-pool=ether1 authoritative=after-2sec-delay bootp-support=static \
    disabled=no interface=ether1 lease-script="" lease-time=10m name=ether1 \
    use-radius=no
add address-pool=ether2 authoritative=after-2sec-delay bootp-support=static \
    disabled=no interface=ether2 lease-script="" lease-time=10m name=ether2 \
    use-radius=no
/ppp profile
...
set [ find default=yes ] disabled=no distribute-default=never !domain-id \
    !domain-tag in-filter=ospf-in metric-bgp=100 metric-connected=20 \
    metric-default=1 metric-other-ospf=100 metric-rip=20 metric-static=20 \
    ...
    router-id=192.168.40.1 !routing-table !use-dn
/routing ospf area
...
set auth=sha1,md5 cipher=blowfish128,aes128 default-profile=default enabled=\
    no keepalive-timeout=60 mac-address=FE:2C:87:3A:D9:53 max-mtu=1500 mode=\
...
add address=192.168.50.1/24 comment=Mgmt disabled=no interface=wlan1 network=\
    192.168.50.0
add address=192.168.141.1/24 disabled=no interface=ether1 network=\
    192.168.141.0
add address=192.168.142.1/24 disabled=no interface=ether2 network=\
    192.168.142.0
add address=192.168.140.1/24 disabled=no interface=loopback0 network=\
    192.168.140.0
/ip cloud
...
add address=192.168.141.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway=192.168.141.1 netmask=24 ntp-server="" wins-server=""
add address=192.168.142.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway=192.168.142.1 netmask=24 ntp-server="" wins-server=""
/ip dns
