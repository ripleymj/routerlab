# jan/02/1970 02:04:24 by RouterOS 6.43.8
# software id = 9RGL-V5LZ
#
# model = RouterBOARD 941-2nD
# serial number = 66170556F52C
/interface ethernet
set [ find default-name=ether1 ] advertise=\
    ...
    E4:8D:8C:C8:1E:56 mtu=1500 name=ether1 orig-mac-address=E4:8D:8C:C8:1E:56 \
...
set [ find default-name=ether2 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    E4:8D:8C:C8:1E:57 mtu=1500 name=ether2 orig-mac-address=E4:8D:8C:C8:1E:57 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    E4:8D:8C:C8:1E:58 mtu=1500 name=ether3 orig-mac-address=E4:8D:8C:C8:1E:58 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether4 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    E4:8D:8C:C8:1E:59 mtu=1500 name=ether4 orig-mac-address=E4:8D:8C:C8:1E:59 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
/interface bridge
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=none allow-sharedkey=\
    ...
    mac-address=E4:8D:8C:C8:1E:5A max-station-count=2007 mode=ap-bridge mtu=\
    ...
    radio-name=E48D8CC81E5A rate-selection=advanced rate-set=default \
    rx-chains=0,1 scan-list=default secondary-channel="" security-profile=\
    default ssid=Router-A3 station-bridge-clone-mac=00:00:00:00:00:00 \
...
add name=ether1 ranges=192.168.131.10-192.168.131.50
add name=ether2 ranges=192.168.132.10-192.168.132.50
/ip dhcp-server
...
add address=192.168.50.1/24 comment=Mgmt disabled=no interface=wlan1 network=\
    192.168.50.0
add address=192.168.131.1/24 disabled=no interface=ether1 network=\
    192.168.131.0
add address=192.168.132.1/24 disabled=no interface=ether2 network=\
    192.168.132.0
add address=192.168.130.1/24 disabled=no interface=loopback0 network=\
    192.168.130.0
/ip cloud
...
add address=192.168.131.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway=192.168.131.1 netmask=24 ntp-server="" wins-server=""
add address=192.168.132.0/24 caps-manager="" dhcp-option="" dns-none=yes \
    gateway=192.168.132.1 netmask=24 ntp-server="" wins-server=""
/ip dns
