...
set [ find default-name=ether1 ] advertise=\
    ...
    B8:69:F4:B5:82:D2 mtu=1500 name=ether1 orig-mac-address=B8:69:F4:B5:82:D2 \
...
set [ find default-name=ether2 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:82:D3 mtu=1500 name=ether2 orig-mac-address=B8:69:F4:B5:82:D3 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:82:D4 mtu=1500 name=ether3 orig-mac-address=B8:69:F4:B5:82:D4 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether4 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:82:D5 mtu=1500 name=ether4 orig-mac-address=B8:69:F4:B5:82:D5 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
/queue interface
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=none allow-sharedkey=\
    ...
    mac-address=B8:69:F4:B5:82:D7 max-station-count=2007 mode=ap-bridge mtu=\
    ...
    radio-name=B869F4B582D7 rate-selection=advanced rate-set=default \
    rx-chains=0,1 scan-list=default secondary-channel="" security-profile=\
    default ssid=Router-B2 station-bridge-clone-mac=00:00:00:00:00:00 \
...
set auth=sha1,md5 cipher=blowfish128,aes128 default-profile=default enabled=\
    no keepalive-timeout=60 mac-address=FE:EB:09:AD:63:AD max-mtu=1500 mode=\
...
add address=192.168.222.1/24 disabled=no interface=ether2 network=\
    192.168.222.0
add address=192.168.220.1/24 disabled=no interface=loopback0 network=\
    192.168.220.0
/ip cloud
