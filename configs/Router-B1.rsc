...
set [ find default-name=ether1 ] advertise=\
    ...
    B8:69:F4:B5:91:A6 mtu=1500 name=ether1 orig-mac-address=B8:69:F4:B5:91:A6 \
...
set [ find default-name=ether2 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:91:A7 mtu=1500 name=ether2 orig-mac-address=B8:69:F4:B5:91:A7 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    ...
    full-duplex=yes l2mtu=1598 loop-protect=default \
    loop-protect-disable-time=5m loop-protect-send-interval=5s mac-address=\
    B8:69:F4:B5:91:A8 mtu=1500 name=ether3 orig-mac-address=B8:69:F4:B5:91:A8 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
...
set [ find default-name=wlan1 ] adaptive-noise-immunity=none allow-sharedkey=\
    ...
    mac-address=B8:69:F4:B5:91:AB max-station-count=2007 mode=ap-bridge mtu=\
    ...
    radio-name=B869F4B591AB rate-selection=advanced rate-set=default \
    rx-chains=0,1 scan-list=default secondary-channel="" security-profile=\
    default ssid=Router-B1 station-bridge-clone-mac=00:00:00:00:00:00 \
...
add address=192.168.210.1/24 disabled=no interface=loopback0 network=\
    192.168.210.0
add address=192.168.211.1/24 disabled=no interface=ether1 network=\
    192.168.211.0
add address=192.168.212.1/24 disabled=no interface=ether2 network=\
    192.168.212.0
/ip cloud
